...
class FundingTransactionsEntryPointTest extends BaseCurrencyCloudTestCase
{
    ...
    public function canRetrieveFundingTransaction(){
        ...
        $entryPoint = new FundingTransactionsEntryPoint($this->getMockedClient(
            json_decode($data),
            'GET',
            'funding_transactions/12345678-abcd-1234-abcd-123456789012',
            [
                'on_behalf_of' => null
            ]
        ));

        $fundingTransaction = $entryPoint->retrieveFundingTransaction('12345678-abcd-1234-abcd-123456789012');
