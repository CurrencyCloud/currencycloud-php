    ...
    public function canFindWithAllParams()
    {
        ...
        $entryPoint = new TransactionsEntryPoint(
            ...
            [
                ...
                'amount_from' => 'A',
                'amount_to' => 'B',
                'settles_at_from' => $dateTimes[0]->format('Y-m-d'),
                'settles_at_to' => $dateTimes[1]->format('Y-m-d'),
                'created_at_from' => $dateTimes[2]->format('Y-m-d'),
                'created_at_to' => $dateTimes[3]->format('Y-m-d'),
                'updated_at_from' => $dateTimes[4]->format('Y-m-d'),
                'updated_at_to' => $dateTimes[5]->format('Y-m-d'),
                'completed_at_from' => $dateTimes[6]->format('Y-m-d'),
                'completed_at_to' => $dateTimes[7]->format('Y-m-d'),
                'page' => null,
                'per_page' => null,
                'order' => null,
                'order_asc_desc' => null,
