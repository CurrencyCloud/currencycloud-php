...
class CurrencyCloudTest extends BaseCurrencyCloudTestCase
{
    ...
    public function onBehalfOfWorks()
    {
        ...
        $mockedClient = $this->createMock(\GuzzleHttp\Client::class, ['request']);
    ...
    public function exceptionWhenEntityIsNotManagedByManager()
    {
        ...
        $this->expectException(RuntimeException::class, 'Entity is not managed by entity manager and therefore can not be updated');
